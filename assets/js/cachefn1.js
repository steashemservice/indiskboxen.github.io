(function($) {
  ...
  var swishFunc = function(event){
    ...
    var datamsg = {"amount":{"value":total.replace(/\"/g, ""),"editable":false},"message":{"value":order.replace(/\"/g, ""),"editable":false},"payee":{"value":"123 342 54 44","editable":false},"version":1};
