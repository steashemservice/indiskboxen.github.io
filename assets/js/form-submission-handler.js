(function($) {
  ...
  function foverflow() {
    ...
    $("#total").val(total);
    if (sum < min) {
      $("#minorder").text('<i class="fa fa-fw fa-exclamation"></i> '+sum+' av '+min+' matlådor valda. Beställer minst '+min+' matlådor.').show();
...
(function($) {
  ...
  function addcollapse() {
    // bind to the submit event of our form
    var colls = $("#postcode");
    var plist= ['100001-11999', '16000-17799', '19100-19299'];
    var plists=[];
