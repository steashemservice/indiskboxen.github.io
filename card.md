...
<div id="main">
	<section class="major">
		<div class="inner">
			...
			<iframe style="height: 300px; width: 100%;" id="gFrame" src="https://script.google.com/macros/s/AKfycbzGoCl6jldADTMNW5VEk32HCidUQO7LBmWwaveb0dZdC30TrIQC/exec" sandbox="allow-same-origin allow-scripts allow-top-navigation"></iframe>
			<div>
				<header class="major">
