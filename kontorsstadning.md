...
<section id="three">
	<div class="inner">
	        <p>En välstadat arbetsplats är viktigt för din anstäldas trivsel. Det ger et positivt intryck på era kunder och klienter när de besöker ert kontor. Steas kontorstädning erbjuder en professionell kontorsstädning för vanliga men även skolor, butiker etc.</p><p>Pris: 289 kr / timme.</p>
		<header class="major">
			<h2>Checklista Kontorsstädning</h2>
		</header>
		<h2>Alla Rum</h2>
		<ul>
